    ...
    cv.Schema(
        {
            ...
            cv.Optional("Frequency"): sensor.sensor_schema(
                accuracy_decimals=0, device_class="frequency", unit_of_measurement="Hz"
            ),
            cv.GenerateID(): cv.declare_id(BL0906),
            cv.Optional("Temperature"): sensor.sensor_schema(
                accuracy_decimals=0, device_class="temperature", unit_of_measurement="℃"
            ),
            cv.GenerateID(): cv.declare_id(BL0906),
            cv.Optional("Voltage"): sensor.sensor_schema(
                accuracy_decimals=0, device_class="voltage", unit_of_measurement="V"
            ),
            cv.Optional("Current_1"): sensor.sensor_schema(
                accuracy_decimals=3, device_class="current", unit_of_measurement="A"
            ),
